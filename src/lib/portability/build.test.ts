		...
		expect(doc.titles).toEqual([
			{
				...
				year: 2010,
				source: 'linked',
				// A provider-backed title's description, structure and credits are re-fetched on import,
				// so the file doesn't carry them — only a user-authored entry has no other source.
				overview: null,
				seasons: null,
				credits: null,
				status: 'completed',
