<script lang="ts">
	...
	/**
	 * Side-by-side comparison of a custom entry and a database candidate, with credit overlap
	 * highlights. Presentational — the parent owns fetching detail and performing the link.
	 */
	interface Props {
		entry: ClientMedia;
