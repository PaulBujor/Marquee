<script lang="ts">
	...
	/**
	 * Shown on a title that one of the user's own entries was matched to: what it was matched from,
	 * and the way back out.
	 *
	 * This is the only route to a linked entry. Once matched it's off every list and out of search,
	 * so without this the match would be permanent in practice even though nothing about it is
