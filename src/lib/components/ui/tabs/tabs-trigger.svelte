...
<TabsPrimitive.Trigger
	...
	class={cn(
		...
		'data-[state=active]:bg-background data-[state=active]:text-foreground dark:data-[state=active]:border-input dark:data-[state=active]:bg-input/60 dark:data-[state=active]:text-foreground',
