...
- **Database schema**: edit `src/lib/server/db/schema.ts`, then `pnpm db:generate` and apply to the local D1 with `pnpm exec wrangler d1 migrations apply marquee --local`.
